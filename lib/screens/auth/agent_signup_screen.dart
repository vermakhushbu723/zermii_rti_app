...
class _AgentSignupScreenState extends State<AgentSignupScreen> {
  ...
  Future<void> _handleSignup() async {
    ...
    final success = await authProvider.register(
      ...
      userType: 'agent',
      address: _companyNameController.text.trim(),
    );

    if (!mounted) return;

    if (success) {
      print('✅ AGENT SIGNUP SUCCESSFUL - Navigating to Agent Dashboard');
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Become a Zermii RTI partner agent',
                    style: TextStyle(
                      fontSize: 16,
