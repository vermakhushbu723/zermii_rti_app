...
class _VendorSignupScreenState extends State<VendorSignupScreen> {
  ...
  Future<void> _handleSignup() async {
    ...
    final success = await authProvider.register(
      ...
      userType: 'vendor',
      address: _businessNameController.text.trim(),
    );

    if (!mounted) return;

    if (success) {
      print('✅ VENDOR SIGNUP SUCCESSFUL - Navigating to Vendor Dashboard');
